...
import kotlinx.android.synthetic.main.fragment_oauth_verify.*
...
internal class OAuthVerifyFragment : BaseFragment(), OAuthVerifyContract.View {

    override fun layoutId() = R.layout.fragment_oauth_verify
    ...
    override fun setUpArguments() {
        dataPoints = requireArguments()[DATA_POINTS_KEY] as DataPointList
        allowedBalanceType = requireArguments()[ALLOWED_BALANCE_TYPE_KEY] as AllowedBalanceType
        tokenId = requireArguments()[TOKEN_ID_KEY] as String
    }
    ...
    private fun setupTheme() {
        ...
        with(themeManager()) {
            ...
            customizeHtml(
                tv_delivery_address_instructions,
                "select_balance_store_oauth_confirm_footer".localized().parseHtmlLinks()
            )
        }
