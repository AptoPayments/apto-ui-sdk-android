...
internal class CustomSnackbar private constructor(parent: ViewGroup, content: View, contentViewCallback: ContentViewCallback) :
    ...
    companion object {
        fun make(rootView: View, duration: Int): CustomSnackbar {
            val inflater = LayoutInflater.from(rootView.context)
            val parent = findSuitableParent(rootView)
            val view = inflater.inflate(R.layout.custom_snackbar, parent, false)
            val callback = ContentViewCallback(view)
            val snackbar = CustomSnackbar(parent!!, view, callback)
