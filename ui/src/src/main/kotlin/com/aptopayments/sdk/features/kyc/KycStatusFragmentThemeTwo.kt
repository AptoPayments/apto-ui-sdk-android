...
internal class KycStatusFragmentThemeTwo: BaseFragment(), KycStatusContract.View {
    ...
    private lateinit var viewModel: KycStatusViewModel
    ...
    companion object {
        fun newInstance(kycStatus: KycStatus, cardID: String): KycStatusFragmentThemeTwo {
            return KycStatusFragmentThemeTwo().apply {
